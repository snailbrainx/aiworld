...
def initialize_db():
    ...
    if cursor.fetchone()[0] == 0:
        ...
        ('John', 'You are John from Glasgow in Scotland. You have a very strong Glaswegian accent. You can attack others. You are on the Red Team which is Lilith, Lucifer and John. Team Blue is Hulk, Lisa and Kelly.', 'B3', 'john.png', 'attack', 0, 150),
